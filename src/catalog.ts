import type { ArabicFont } from './types.js';
...
export const catalogGeneratedAt = "2026-08-14T18:59:07.610Z";
export const catalogSource = "https://api.fontsource.org/v1/fonts";
